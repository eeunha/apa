            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
	                ...
	                <div class="d-sm-flex align-items-center justify-content-between mb-4">
	                	<h1 class="h3 mb-0 text-gray-800 hansans" style="padding-top: 28px;">자녀 정보</h1>
	                </div>
                        ...
                        <div class="col-xl-12">
                            <div class="card shadow mb-5">
                                ...
                                <div
                                    ...
                                    <h5 class="m-0 font-weight-bold text-primary">내 자녀</h5>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
									<table id="list">
										...
										<tbody>
											...
											<tr>
												...
												<td>
													<div>
														<i class="fas fa-fw fa-edit" onclick="edit(${dto.childSeq});"></i>
														<i class="fas fa-fw fa-times" onclick="del(${dto.childSeq});"></i>
													</div>
												</td>
											</tr>
											</c:forEach>
									...
									<div><button class="out" id="toggleAdd" type="button">자녀 등록</button></div>
