            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link click-scroll" href="/apa/user/info/view.do">병원/약국 찾기</a>
                        </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-12 mx-auto">
                            ...
                            <div class="category-block d-flex flex-column">
                                <h5 class="mb-3 hansans">Categories</h5>
								<a href="#" class="category-block-link">
                                    의학 상담
                                </a>
                                <a href="#" class="category-block-link">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-12 mb-4">
                        <img src="/apa/asset/images/logo.png" class="logo img-fluid" alt="">
                    </div>

                    <div class="col-lg-4 col-md-6 col-12 mb-4">
                        <h5 class="site-footer-title mb-3">서비스</h5>

                        <ul class="footer-menu" style="padding-bottom: 20px;">
                            <li class="footer-menu-item"><a href="#" class="footer-menu-link">서비스 소개</a></li>
                            <li class="footer-menu-item"><a href="#" class="footer-menu-link">공지사항</a></li>
                        </ul>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mx-auto">
                        <h5 class="site-footer-title mb-3">(주)아파! 어디가?</h5>
                        ...
                        <a href="#" class="custom-btn btn mt-3">위로가기</a>
                    </div>
                </div>
            </div>
