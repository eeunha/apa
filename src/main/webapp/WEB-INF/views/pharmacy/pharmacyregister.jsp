                ...
                <div class="col-xl-12">
                    <div class="card shadow mb-5" style="margin: 0 auto; width: 80%;">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800 hansans" style="margin-left: 40px;">약국 회원가입</h1>
                        </div>
                    <!-- Card Body -->
                    <div class="card-body">
                        <form name="form" method="POST" action="/apa/pharmacy/pharmacyregister.do" onsubmit="return checkAll()">
                            <div id="my-info">
                                <div id="my-info-name">
