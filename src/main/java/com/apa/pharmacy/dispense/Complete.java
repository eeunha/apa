 ...
 * 제조 완료를 처리하는 서블릿
 */
@WebServlet("/pharmacy/dispense/complete.do")
public class Complete extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        ArrayList<DispenseDTO> dtoList = dispenseDAO.getDispenseCompletePagingList(map);
        ...
        if (cntDto.getJejoFinCnt() == null) {
            
        } else {            
            totalPage = (int)Math.ceil((double)Integer.parseInt(cntDto.getJejoFinCnt()) / pageSize);
        }
        ...
        if(n == 1) {
            ...
            sb.append(String.format(("<a href='/apa/pharmacy/dispense/complete.do?page=%d'><<<</a>"), n-1, pageSize));
        }
        ...
        while(!(loop > pageSize || n > totalPage)) {
            ...
            if (n == nowPage) {
                ...
                sb.append(String.format(" <a href='/apa/pharmacy/dispense/complete.do?page=%d'>%d</a> ", n, n));
            }
        ...
        if(n > totalPage) {
            ...
            sb.append(String.format(("<a href='/apa/pharmacy/dispense/complete.do?page=%d'>>>></a>"), n, pageSize));
        }
        
        req.setAttribute("pagebar", sb.toString());
        req.setAttribute("pharmacyId", pharmacyId);
        
        RequestDispatcher dispatcher = req.getRequestDispatcher("/WEB-INF/views/pharmacy/dispense/complete.jsp");
